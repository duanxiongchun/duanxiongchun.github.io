...
function launchAnalogy(level, container) {
  ...
  container.innerHTML = `
    <div class="glass-card game-stage-card" style="border-color:rgba(167,139,250,0.3);">
      ...
      <div class="glass-card" style="padding:20px;margin:20px 0;background:rgba(167,139,250,0.06);border-color:rgba(167,139,250,0.2);">
        <p style="font-size:1.25em;color:#fff;font-weight:700;line-height:1.6;margin:0;">${q.text}</p>
      </div>
